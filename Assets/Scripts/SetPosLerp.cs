...
public class SetPosLerp : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        line2 = _RightLine.GetComponent<LineRenderer>();
    ...
    private void Update()
    {
        ...
        if (goodToGo)
        {
            ...
            if (distCovered < journeyLength)
            {
                ...
                line1.positionCount = counter;
                line2.positionCount = counter;

                line1.SetPosition(counter-1, newPoint);
                line2.SetPosition(counter-1, newPointR);
            }
